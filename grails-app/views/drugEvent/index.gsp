...
<div id="wrapper">
		            ...
		            <div class="navbar-default sidebar" role="navigation">
		                <div class="sidebar-nav navbar-collapse">
		                    <ul class="nav" id="side-menu">
		                        <li>
		                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Examine Data<span class="fa arrow"></span></a>
		        ...
		        <div id="page-wrapper">
		            <div class="row">
		                <div class="col-lg-12">
		                    <h1 class="page-header">Adverse Drug Events in the United States</h1>
		                </div>
		                <div class="overview">
		                	<p>
		                ...
		                <div class="col-lg-4">
		                    <div class="panel panel-default">
		                        ...
		                        <div class="panel-body">
		                            ...
		                            <!-- /.list-group -->
		                            <a href="#" class="btn btn-default btn-block">Reset All Filters</a>
		                        </div>
		                        <!-- /.panel-body -->
		                    </div>
		                    <!-- /.panel -->
